...
//        itemRequestService.setClock(clock);
    ...
    void getById() {
        ...
        final ItemRequestDtoResponse actualRequest = itemRequestService.getById(userId, requestId);
    ...
    void getAllByRequestOwner() {
        ...
        final List<ItemRequestDtoResponse> exitedDtoList = List.of(
        ...
        final List<ItemRequestDtoResponse> actualRequestList = itemRequestService.getAllByRequestOwner(userId);
    ...
    void getAllFromOtherUsers() {
        ...
        final List<ItemRequestDtoResponse> actualRequestList = itemRequestService.getAllFromOtherUsers(userId, null);
    ...
    void getAllFromOtherUsers_withPagination() {
        ...
        final List<ItemRequestDtoResponse> actualRequestList = itemRequestService.getAllFromOtherUsers(userId, page);
    ...
    void create() {
        ...
        final ItemRequestDtoResponse exitedRequestDto = ItemRequestMapper.toDto(itemRequest);

        when(userRepository.findById(anyLong())).thenReturn(Optional.of(user));
        when(itemRequestRepository.save(any())).thenReturn(itemRequest);

        final ItemRequestDtoResponse actualRequest = itemRequestService.create(userId, requestDto);
