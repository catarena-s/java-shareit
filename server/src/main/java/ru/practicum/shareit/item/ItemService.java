...
public interface ItemService {
     ...
     */
    Collection<ItemDtoResponse> getAllByOwner(long userId, PageRequest page);
     ...
     */
    ItemDtoResponse create(ItemDto item, long userId);
     ...
     */
    ItemDtoResponse update(ItemDto item, long itemId, long userId);
     ...
     * @return collection of items, converted to DTO
     */
    List<ItemDtoResponse> search(String text, PageRequest page);
